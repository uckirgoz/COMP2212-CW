...
Filter : FILTER ASK '{' DataProposition WHERE '{' WhereProposition '}' '}'      { Ask $4 $7 }
...
BooleanIntExp : BooleanIntExp ',' BooleanIntExp    { MultiBoolSttmnt $1 $3 }
              ...
              | Variable '!=' ObjExp                  { NotEq $1 $3 } --this might be causing the problem.
              | Variable '==' ObjExp                  { IsEq $1 $3 }
              | BooleanIntExp or BooleanIntExp         { OrBoolTerm $1 $3 }
